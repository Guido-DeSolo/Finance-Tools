"""Safe runtime-mode selection shared by DF-FinTechTerm entry points."""
...
class ExecutionMode(str, Enum):
    ...
    def parse(cls, value: str | None) -> "ExecutionMode":
        ...
        try:
            ...
            raise ValueError(f"DF_FINTECHTERM_MODE must be one of: {choices}") from error
...
class RuntimeConfig:
    ...
    def from_env(cls) -> "RuntimeConfig":
        return cls(ExecutionMode.parse(os.environ.get("DF_FINTECHTERM_MODE")))
