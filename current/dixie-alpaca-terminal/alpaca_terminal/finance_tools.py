...
FINANCE_TOOLS = (
    ...
    FinanceTool("sentiment-analyze", "Sentiment · analyze article", ("sentiment", "analyze"), "ARTICLE_ID and optional flags"),
    FinanceTool("sentiment-pending", "Sentiment · analyze pending", ("sentiment", "pending"), "optional flags"),
    FinanceTool("sentiment-list", "Sentiment · list results", ("sentiment", "list"), "optional SYMBOL and flags"),
    ...
    FinanceTool("plutus-services", "Plutus services · catalog", ("plutus", "services")),
    FinanceTool("plutus-service-run", "Plutus services · run worker", ("plutus", "service"), "SERVICE and optional arguments"),
    FinanceTool("plutus-actions", "Plutus actions · catalog", ("plutus", "actions")),
    FinanceTool("plutus-action-run", "Plutus actions · run research", ("plutus", "action"), "ACTION and optional arguments"),
