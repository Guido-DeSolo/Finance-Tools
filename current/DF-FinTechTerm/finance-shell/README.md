...
```bash
source /home/guyyatsu/Finance-Tools/current/DF-FinTechTerm/finance-shell/activate.bash
fsh help
```
...
```bash
sqlite3 /home/guyyatsu/Finance-Tools/current/DF-FinTechTerm/finance-shell/data/alpaca.sqlite3
```
