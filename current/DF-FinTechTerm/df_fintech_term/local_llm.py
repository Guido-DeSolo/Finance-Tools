...
# Change this one value when DF-FinTechTerm should use a different specific local model.
...
SYSTEM_PROMPT = (
    "You are the local assistant embedded in DF-FinTechTerm. Be concise, "
...
class LocalLLM:
    ...
    def chat(self, messages: list[dict[str, str]]) -> str:
        ...
        request = Request(
            ...
            headers={"Content-Type": "application/json", "User-Agent": "df-fintechterm/1"},
            method="POST",
        )
        try:
