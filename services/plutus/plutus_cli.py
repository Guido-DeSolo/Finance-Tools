#!/usr/bin/env python3
"""Explicit command boundary between Plutus services and user actions."""
...
from plutus_core import RuntimeConfig
...
def parser() -> argparse.ArgumentParser:
    command = argparse.ArgumentParser(
        prog="plutus",
        description="Plutus backend: services are scheduled workers; actions are user-requested jobs.",
    )
