# Plutus architecture inventory and gap report
...
NEWS v2 closely matches the Plutus specification:
...
execution-mode contract, no `PLUTUS_MODE`, and no paper/live guard.
...
1. Introduce a `plutus` package containing typed, timezone-aware contracts for
